        ...
        <div className="relative z-10 flex items-center px-6 py-20 lg:px-16">
          ...
          <div className="relative w-full max-w-xl space-y-8">
            ...
            <p className="text-xl leading-relaxed text-gray-600 lg:text-2xl">
              Transform your organization's performance management with our innovative platform. Say
              goodbye to outdated processes and hello to a smarter, more efficient way of driving
              continuous improvement across your entire workforce.
            </p>
